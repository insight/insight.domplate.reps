...
function impl(domplate) {
    ...
    return {
        ...
        tag: T.SPAN({ "class": "string", "wrapped": "$node.wrapped" }, T.IF("$node.wrapped", "'"), T.FOR("line", "$node|getValue", "$line.value", T.IF("$line.special", T.SPAN({ "class": "special" }, "$line.specialvalue")), T.IF("$line.more", T.BR()), T.IF("$line.trimmed", T.TAG("$node|getTrimmedTag", { "node": "$node" }))), T.IF("$node.wrapped", "'")),

        shortTag: T.SPAN({ "class": "string", "wrapped": "$node.wrapped" }, T.IF("$node.wrapped", "'"), T.FOR("line", "$node|getShortValue", "$line.value", T.IF("$line.special", T.SPAN({ "class": "special" }, "$line.specialvalue")), T.IF("$line.more", T.BR()), T.IF("$line.trimmed", T.TAG("$node|getTrimmedTag", { "node": "$node" }))), T.IF("$node.wrapped", "'")),

        trimmedNoticeTag: T.SPAN({ "class": "trimmed" }, "$node|getNotice"),
